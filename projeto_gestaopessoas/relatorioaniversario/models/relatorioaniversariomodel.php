...
require_once("resources/relatorioaniversario/dompdf/dompdf_config.inc.php");

class relatorioaniversariomodel extends CI_Model {
...
//                            }
    ...
    public function getPdf($mes, $idEmpresa, $idFilial) {
       ...
       $dataAtualizada = date('d/m/Y');
        ...
        $html .= "<td rowspan = '2' colspan = '2'  align = 'center' style = 'font-size: 22px; color: #ffffff;'><b>&nbsp;&nbsp;RELATÓRIO DE ANIVERSARIO</b></td></tr>";
                    ...
                    if (is_array($rs) && count($rs) > 0) {
                        ...
                        for ($i = 0; $i < $tamanho; $i++) {
                            ...
                            if ($dataAdmissaoComparacao == $dataAtualizadaComparacao) {
                                ...
                                $html .= "<tr class = 'linhaOc' style = 'width:100%;'>";
                                $html .= "<td  style = ' background-color: #FFC0CB;text-transform: uppercase; width: 10%; font-size: 16px;' align = 'left'><b>&nbsp;&nbsp;$matricula</b></td>";
                                $html .= "<td  colspan = '2' style = ' background-color: #FFC0CB;text-transform: uppercase; width: 20%; font-size: 16px;' align = 'left'><b>$nomeFuncionario</b></td>";
                                $html .= "<td  colspan = '2' style = ' background-color: #FFC0CB;text-transform: uppercase; width: 20%; font-size: 16px;' align = 'left'><b>$funcao</b></td>";
                                $html .= "<td  style = ' background-color: #FFC0CB;width: 10%; font-size: 16px;' align = 'left'><b>&nbsp;&nbsp;$dataAdmissao</b></td>";
                                $html .= "<td  style = ' background-color: #FFC0CB;width: 10%; font-size: 16px;' align = 'center'><b>&nbsp;&nbsp;$mesAdmissao</b></td>";
                                $html .= "<td  colspan = '2' style = 'text-transform: uppercase; background-color: #FFC0CB; width: 20%; font-size: 16px;' align = 'center'><b>&nbsp;&nbsp;$tempoEmpresa</b></td>";

                                $html .= "</tr>";
                            } else {
                                $html .= "<tr class = 'linhaOc' style = 'width:100%;'>";
                                $html .= "<td  style = 'text-transform: uppercase; width: 10%; font-size: 16px;' align = 'left'><b>&nbsp;&nbsp;$matricula</b></td>";
                                $html .= "<td  colspan = '2' style = 'text-transform: uppercase; width: 20%; font-size: 16px;' align = 'left'><b>$nomeFuncionario</b></td>";
                                $html .= "<td  scolspan = '2' tyle = 'text-transform: uppercase; width: 20%; font-size: 16px;' align = 'left'><b>$funcao</b></td>";
                                $html .= "<td  style = 'width: 10%; font-size: 16px;' align = 'left'><b>&nbsp;&nbsp;$dataAdmissao</b></td>";
                                $html .= "<td  style = 'width: 10%; font-size: 16px;' align = 'center'><b>&nbsp;&nbsp;$mesAdmissao</b></td>";
                                $html .= "<td  colspan = '2' style = 'text-transform: uppercase;width: 20%; font-size: 16px;' align = 'center'><b>&nbsp;&nbsp;$tempoEmpresa</b></td>";
...
//
//                                $j = $i + 1;
//                                $equipamentoAtual = $rs[$i]->ID_FUNCIONARIO;
//                                //print_r($equipamentoAtual); exit();
//
//                                $equipamentoProx = $rs[$j]->ID_FUNCIONARIO;
//                                $dataAtual = $rs[$i]->DATA_ADMISSAO;
//                                $dataProx = $rs[$j]->DATA_ADMISSAO;
//                            } else {
//
//                                $equipamentoAtual = $rs[$i]->ID_FUNCIONARIO;
//                                //print_r($equipamentoAtual); exit();
...
//
//
//                            if ($equipamentoAtual != $equipamentoProx || $dataAtual != $dataProx) {
//
//
//                                ///print_r($equipamentoProx);exit();
//                                
//                            }
                        }
                    }
                    ...
                    if (is_array($rs) && count($rs) > 0) {
                        ...
                        for ($i = 0; $i < $tamanho; $i++) {
                            ...
                            if ($dataAdmissaoComparacao == $dataAtualizadaComparacao) {
                                ...
                                $html .= "<td  style = 'text-transform: uppercase; width: 10%; font-size: 16px;' align = 'left'><b>&nbsp;&nbsp;$matricula</b></td>";
                                $html .= "<td  colspan = '2' style = 'text-transform: uppercase; width: 20%; font-size: 16px;' align = 'left'><b>$nomeFuncionario</b></td>";
                                $html .= "<td  colspan = '2' style = 'text-transform: uppercase; width: 20%; font-size: 16px;' align = 'left'><b>$funcao</b></td>";
                                $html .= "<td  style = 'width: 10%; font-size: 16px;' align = 'left'><b>&nbsp;&nbsp;$dataAdmissao</b></td>";
                                $html .= "<td  style = 'width: 10%; font-size: 16px;' align = 'center'><b>&nbsp;&nbsp;$mesAdmissao</b></td>";
                                $html .= "<td  colspan = '2' style = 'text-transform: uppercase;width: 20%; font-size: 16px;' align = 'center'><b>&nbsp;&nbsp;$tempoEmpresa</b></td>";
