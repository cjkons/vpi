...
function verificarLancamentoEpi() {
    ...
    $.ajax({
        url: 'index.php?m=entregaepi&c=entregaepicontroller&f=verificarLancamentoEpi',
        data: {
...
function validarSalvarLancamento() {
    ...
    $.ajax({
        url: 'index.php?m=entregaepi&c=entregaepicontroller&f=validarSalvarLancamento',
        data: {
            id: id,
            codCa: codCa
...
function salvarLancamento() {
    ...
    if (controleDePreenchimento == 'S') {
        ...
        $.ajax({
            url: 'index.php?m=entregaepi&c=entregaepicontroller&f=salvarLancamento',
            data: {
                id: id,
                codCa: codCa,
                tipoEpi: tipoEpi,
...
function salvar() {
    ...
    if (controleDePreenchimento == 'S') {
        ...
        $.ajax({
            url: 'index.php?m=entregaepi&c=entregaepicontroller&f=salvar',
            data: {
                id: id,
                idFuncionario: idFuncionario,
                matricula: matricula,
...
function salvarItensLancamentos() {
    ...
    for (var i = 1; i <= linhas; i++) {
        ...
        if (controleDePreenchimento == 'S') {
            ...
            $.ajax({
                url: 'index.php?m=entregaepi&c=entregaepicontroller&f=salvarItensLancamentos',
                data: {
                    id: id,
                    codCa: codCa,
                    tipoEpi: tipoEpi,
...
function getNumeroLinhas() {
    ...
    var retorno;
    $.ajax({
        url: 'index.php?m=entregaepi&c=entregaepicontroller&f=getNumeroLinhas',
        data: {
            id: id
...
function salvarLancamentoEd() {
    ...
    if (controleDePreenchimento == 'S') {
        ...
        $.ajax({
            url: 'index.php?m=entregaepi&c=entregaepicontroller&f=salvarLancamentoEd',
            data: {
                id: id,
                codCa: codCa,
                tipoEpi: tipoEpi,
...
function salvarLancamentoEdEd() {
    ...
    if (controleDePreenchimento == 'S') {
        ...
        $.ajax({
            url: 'index.php?m=entregaepi&c=entregaepicontroller&f=salvarLancamentoEdEd',
            data: {
                id: id,
                codCa: codCa,
                tipoEpi: tipoEpi,
...
function excluir() {
    ...
    $.ajax({
        url: 'index.php?m=entregaepi&c=entregaepicontroller&f=excluir',
        data: {
            id: id
        },
        type: 'POST',
...
function excluirLancamentoModalEd() {
    ...
    $.ajax({
        url: 'index.php?m=entregaepi&c=entregaepicontroller&f=excluirLancamentoModalEd',
        data: {
            codCaEd: codCaEd,
            id: id
...
function excluirLancamentoModalEdEd() {
    ...
    $.ajax({
        url: 'index.php?m=entregaepi&c=entregaepicontroller&f=excluirLancamentoModalEdEd',
        data: {
            codCaEdEd: codCaEdEd,
            id: id
...
function excluirDadosTemp() {
    ...
    $.ajax({
        url: 'index.php?m=entregaepi&c=entregaepicontroller&f=excluirDadosTemp',
        data: {
        },
        type: 'POST',
        dataType: 'json',
...
function  getItemLancamentoEditar() {
    ...
    $.ajax({
        url: 'index.php?m=entregaepi&c=entregaepicontroller&f=getItemLancamentoEditar',
        data: {
            id: id
        },
        type: 'POST',
...
function  getItemLancamentoEditarEd() {
    ...
    $.ajax({
        url: 'index.php?m=entregaepi&c=entregaepicontroller&f=getItemLancamentoEditarEd',
        data: {
            id: id
        },
        type: 'POST',
...
function  getItemLancamento(id) {
    ...
    $.ajax({
        url: 'index.php?m=entregaepi&c=entregaepicontroller&f=getItemLancamento',
        data: {
            id: id
        },
        type: 'POST',
...
function  getEditarItemLancamento(id) {
    ...
    $.ajax({
        url: 'index.php?m=entregaepi&c=entregaepicontroller&f=getEditarItemLancamento',
        data: {
            id: id
        },
        type: 'POST',
...
function  getEditarItemLancamentoEd(id) {
    ...
    $.ajax({
        url: 'index.php?m=entregaepi&c=entregaepicontroller&f=getEditarItemLancamentoEd',
        data: {
            id: id
        },
        type: 'POST',
...
function getGrid() {
    ...
    $('#grid').DataTable({
        "destroy": true,
        ajax: {
            "url": "index.php?m=entregaepi&c=entregaepicontroller&f=getGrid",
            "data": objFiltro,
            "type": "POST",
        },
        language: {
...
function editarItemLancamentoTemporario(idLancamentoItem) {
    ...
    $.ajax({
        url: 'index.php?m=entregaepi&c=entregaepicontroller&f=editarItemLancamentoTemporario',
        data: {
            id: id,
...
function editarItemLancamento(idLancamentoItem) {
    ...
    $.ajax({
        url: 'index.php?m=entregaepi&c=entregaepicontroller&f=editarItemLancamento',
        data: {
            id: id,
            idLancamentoItem: idLancamentoItem
...
function editarItemLancamentoEd(idLancamentoItem) {
    ...
    $.ajax({
        url: 'index.php?m=entregaepi&c=entregaepicontroller&f=editarItemLancamentoEd',
        data: {
            id: id,
            idLancamentoItem: idLancamentoItem
...
function editarLancamento(id) {
    ...
    $.ajax({
        url: 'index.php?m=entregaepi&c=entregaepicontroller&f=editarLancamento',
        data: {
            id: id
...
function novoModal() {
    ...
    $.ajax({
        url: 'index.php?m=entregaepi&c=entregaepicontroller&f=novo',
        data: {
        },
        type: 'POST',
        dataType: 'json',
...
function carregarCodCa1(funcao) {
    ...
    $.ajax({   
        url: 'index.php?m=entregaepi&c=entregaepicontroller&f=carregarCodCa1',
        data: {
...
function carregarCodCa() {
    ...
    $.ajax({
        url: 'index.php?m=entregaepi&c=entregaepicontroller&f=carregarCodCa',
        data: {
...
function carregarTipoEpi() {
    ...
    $.ajax({
        url: 'index.php?m=entregaepi&c=entregaepicontroller&f=carregarTipoEpi',
        data: {
            codCa: codCa
...
function carregarFuncionario() {
    ...
    $.ajax({
        url: 'index.php?m=entregaepi&c=entregaepicontroller&f=carregarFuncionario',
        data: {
        },
        type: 'POST',
        dataType: 'json',
...
function carregarDadosFuncionario() {
    ...
    $.ajax({
        url: 'index.php?m=entregaepi&c=entregaepicontroller&f=carregarDadosFuncionario',
        data: {
            idFuncionario: idFuncionario
...
function getPdf() {
   ...
   var controleDePreenchimento = 'S';
    ...
    if(controleDePreenchimento ==  'S'){
        ...
        $.ajax({
            url: 'index.php?m=entregaepi&c=entregaepicontroller&f=getPdf',
            data: {
...
function abrirArquivoPdf() {
  ...
  window.open('http://189.11.172.90/gestaopessoas/fwk/uploads/pdf/.relatorio_entregaEpi.pdf'); // servidor 
    //window.open('http://localhost/gestaopessoas/fwk/uploads/pdf/.relatorio_entregaEpi.pdf'); //- local
...
function verificarQuantidadePermitida() {
