...
class cadastrogrupoempresamodel extends CI_Model {
    ...
    public function novo(){
        ...
        $query = "SELECT max(ID_GRUPO_EMPRESA) AS ID_GRUPO_EMPRESA FROM  GP_SYS_GRUPO_EMPRESA";
    ...
    public function salvar($idGrupoEmpresa, $denomincaoGrupoEmpresa){
        ...
        $query = "SELECT * FROM GP_SYS_GRUPO_EMPRESA  WHERE ID_GRUPO_EMPRESA = $idGrupoEmpresa";
        ...
        if (is_array($rs) && count($rs) > 0){
            ...
            $query = "UPDATE GP_SYS_GRUPO_EMPRESA SET DENOMINACAO = '$denomincaoGrupoEmpresa', USUARIO_ALTERACAO = '$usuarioLogado', DATA_ALTERACAO = SYSDATE WHERE ID_GRUPO_EMPRESA = $idGrupoEmpresa";
            ...
            $query = "SELECT MAX(ID) AS ID FROM  GP_SYS_GRUPO_EMPRESA";
            ...
            $query = "INSERT INTO GP_SYS_GRUPO_EMPRESA (ID, ID_GRUPO_EMPRESA, DENOMINACAO, USUARIO_CADASTRO, DATA_CADASTRO)
    ...
    public function excluir($idGrupoEmpresa){
        ...
        $query = "DELETE FROM GP_SYS_GRUPO_EMPRESA WHERE ID_GRUPO_EMPRESA = $idGrupoEmpresa";
    ...
    public function buscaPrimeiroRegistro(){
        ...
        $query = "SELECT * FROM GP_SYS_GRUPO_EMPRESA ORDER BY ID_GRUPO_EMPRESA";
    ...
    public function buscaRegistroAnterior($idGrupoEmpresa){
        ...
        for($i =0; $i < 10; $i++){
            ...
            $query = "SELECT * FROM GP_SYS_GRUPO_EMPRESA WHERE ID_GRUPO_EMPRESA =  $idProcura";
    ...
    public function pesquisaSimples($idInicial, $nomeInicial){
        ...
        if($idInicial == "" || $idInicial == null ){
            ...
            $query = "SELECT * FROM GP_SYS_GRUPO_EMPRESA WHERE DENOMINACAO LIKE '%$nomeInicial%'";
            ...
            $query = "SELECT * FROM GP_SYS_GRUPO_EMPRESA WHERE ID_GRUPO_EMPRESA LIKE '%$idInicial%'";
    ...
    private function getCountGrid(){
        ...
        $query = "SELECT COUNT(ID) AS TOTAL FROM GP_SYS_GRUPO_EMPRESA";
