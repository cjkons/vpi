        ...
        <table style="width: 80%; border-collapse: collapse" cellpadding="0" cellspacing="5px" align="center" >
                <tr>
                    ...
                    <td  style="width: 20%;padding-right: 10px;font-size: 14px;">
                        <div class="form-group">
                            Empresa
                            <select style="text-transform: uppercase;" id="idEmpresa" class="form-control"  readonly onchange="carregarFilial()" ></select>
                        </div>
                    </td>
                    <td  style="width: 20%;padding-right: 10px;font-size: 14px;">
                        <div class="form-group">
                            Filial
                            <select style="text-transform: uppercase;" id="idFilial" class="form-control"  readonly onchange="carregarFuncionario()" ></select>
                        </div>
                    </td>
                ...
                <tr>  
                   ...
                   <td  style="width: 10%; padding-right: 10px;font-size: 14px;">
                    ...
                    <td  style="width: 10%; padding-right: 10px;font-size: 14px;">
                          <div class="form-group">
                            Dias Haver
                            <input style="text-transform: uppercase;" type="number" class="form-control" id="diasHaver"  placeholder="Dias Haver" readonly>
                        </div>
                    </td>
                    <td  style="width: 20%; padding-right: 10px;font-size: 14px;">
