...
<html lang="pt-br">
    <head>
        ...
        <!--GERAL-->
        <link href="resources/entregaepibloco/css/teste.css" rel="stylesheet">
        ...
        <!-- CADASTRO EVENTO -->
        <script src="resources/entregaepibloco/js/entregaepibloco.js"></script>
        <!-- CADASTRO EVENTO -->
    </head>
        ...
        <div class="modal-dialog-esp">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <h4 class="modal-title" id="myModalLabel">Entrega EPI Bloco</h4>
                </div>
                        ...
                        <table style="width: 90%; border-collapse: collapse" cellpadding="0" cellspacing="5px" align="center" >
                            <tr>
                                ...
                                <td  style="width: 10%; width: 20%; padding-right: 10px;font-size: 14px;">
                                    <div class="form">
                                        ...
                                        <select style="text-transform: uppercase;" id="estadoEpi" class="form-control" readonly>
                                            ...
                                            <option readonly value="N">Novo</option>
                                            <option readonly value="H">Higienizado</option>
                                        </select> 
                                    </div>
                                </td>
                                ...
                                <td  style="width: 10%; padding-right: 5px;font-size: 14px;">
                                    <div class="form">
                                        Nº Bloco
                                        <input type="text" class="form-control" id="blocoEpi"  placeholder="Nº Bloco" readonly>
                                    </div>
                                </td>
                            </tr>
                        ...
                        <table style="width: 90%; border-collapse: collapse" cellpadding="0" cellspacing="5px" align="center" >
                            <tr>
                                ...
                                <td  style="width: 10%; padding-right: 5px;font-size: 14px;">
                                    <div class="form">
                                        Nº Bloco
                                        <input type="text" class="form-control" id="blocoEpiEd"  placeholder="Nº Bloco" readonly>
                                    </div>
                                </td>
                            </tr>
        ...
        <div class="modal-dialog-esp">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <h4 class="modal-title" id="myModalLabel">Editar EPI's Adicionados ED</h4>
                </div>
                <div class="modal-body">
                    <nav class="navbart">
                        <div class="container-fluid" align="center">
                        ...
                        <table style="width: 90%; border-collapse: collapse" cellpadding="0" cellspacing="5px" align="center" >
                            <tr>
                                ...
                                <td  style="width: 10%; padding-right: 5px;font-size: 14px;">
                                    <div class="form">
                                        Nº Bloco
                                        <input type="text" class="form-control" id="blocoEpiEdEd"  placeholder="Nº Bloco" readonly>
                                    </div>
                                </td>
                            </tr>
