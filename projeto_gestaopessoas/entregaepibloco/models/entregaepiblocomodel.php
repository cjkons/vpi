<?php
require_once("resources/entregaepibloco/dompdf/dompdf_config.inc.php");

class entregaepiblocomodel extends CI_Model { 
    ...
    public function novo() {
        ...
        $query = "SELECT max(ID_EPI_ENT) AS ID FROM  GP_EPI_ENT_BLOCO";
    ...
    public function verificarLancamentoEpi($id, $idFuncionario) {
        ...
        $query = "SELECT * FROM GP_EPI_ENT_BLOCO WHERE FUNCIONARIO = '$idFuncionario'";
            ...
            if (is_array($rs) && count($rs) > 0) {
                ...
                $query = "SELECT * FROM GP_EPI_ENT_BLOCO WHERE ID_EPI_ENT = '$id' AND  FUNCIONARIO = '$idFuncionario'";
    ...
    public function salvar($id, $idFuncionario, $matricula, $setor, $funcao, $dataAdmissao) {
        ...
        $query = "SELECT * FROM GP_EPI_ENT_BLOCO  WHERE ID_EPI_ENT = $id";
        ...
        if (is_array($rs) && count($rs) > 0) {
            ...
            $query = "UPDATE GP_EPI_ENT_BLOCO SET FUNCIONARIO  = '$idFuncionario' , MATRICULA = '$matricula', SETOR = '$setor', FUNCAO = '$funcao', DATA_ADMISSAO = '$dataAdmissao' DATA_ALTERACAO = SYSDATE, USUARIO_ALTERACAO = '$usuarioLogado' WHERE ID_EPI_ENT = $id";
            ...
            $query = "INSERT INTO GP_EPI_ENT_BLOCO (ID_EPI_ENT, FUNCIONARIO, MATRICULA, SETOR, FUNCAO, DATA_ADMISSAO, DATA_CADASTRO, USUARIO_CADASTRO)
...
///// SE O ID NAO ESTIVER SALVO, VAI SALVAR OS FILHOS NA TABELA ITEM TEMP     
        if (is_array($rs) && count($rs) == null) {
            ...
            $query = "SELECT * FROM GP_EPI_ENT_BLOCO_ITEM_TEMP  WHERE ID_EPI_ENT = '$id' AND COD_CA = '$descricaoCodCa'";
            ...
            $query = "SELECT * FROM GP_EPI_ENT_BLOCO_ITEM WHERE ID_EPI_ENT = '$id' AND COD_CA = '$descricaoCodCa'";
    ...
    public function salvarLancamento($id, $codCa, $tipoEpi, $qtdEpi, $estadoEpi, $dataEpi, $blocoEpi) {
        // print_r("salvarDescricao");exit();
        $this->initConBanco();
...
///// SE O ID NAO ESTIVER SALVO, VAI SALVAR OS FILHOS NA TABELA ITEM TEMP     
        if (is_array($rs) && count($rs) == null) {
            ...
            if (is_array($rs) && count($rs) > 0) {
                ...
                $query = "UPDATE GP_EPI_ENT_BLOCO_ITEM_TEMP SET COD_CA = '$descricaoCodCa', TIPO_EPI = '$tipoEpi', QTD_EPI = '$qtdEpi', N_H = '$estadoEpi', DATA = '$dataEpi', BLOCO_EPI = '$blocoEpi', DATA_ALTERACAO = SYSDATE, USUARIO_ALTERACAO = '$usuarioLogado' WHERE ID_EPI_ENT LIKE '%$id%' AND COD_CA = '$descricaoCodCa'";
                ...
                $query = "SELECT MAX(ID_EPI_ENT_ITEM) AS ID_EPI_ENT_ITEM FROM GP_EPI_ENT_BLOCO_ITEM_TEMP";
                ...
                $query = "INSERT INTO GP_EPI_ENT_BLOCO_ITEM_TEMP (ID_EPI_ENT, ID_EPI_ENT_ITEM, COD_CA, TIPO_EPI, QTD_EPI, N_H, DATA, BLOCO_EPI, DATA_CADASTRO, USUARIO_CADASTRO)
                                 VALUES ($id, $novoId, '$descricaoCodCa', '$tipoEpi', '$qtdEpi', '$estadoEpi', '$dataEpi', '$blocoEpi', SYSDATE, '$usuarioLogado')";
...
/// SENAO VAI SALVAR OS FILHOS NA TABELA ITEM            
            ...
            if (is_array($rs) && count($rs) > 0) {
                ...
                $query = "UPDATE GP_EPI_ENT_BLOCO_ITEM SET COD_CA = '$descricaoCodCa', TIPO_EPI = '$tipoEpi', QTD_EPI = '$qtdEpi', N_H = '$estadoEpi', DATA = '$dataEpi', BLOCO_EPI = '$blocoEpi', DATA_ALTERACAO = SYSDATE, USUARIO_ALTERACAO = '$usuarioLogado' WHERE ID_EPI_ENT LIKE '%$id%' AND COD_CA = '$descricaoCodCa'";
                ...
                $query = "SELECT MAX(ID_EPI_ENT_ITEM) AS ID_EPI_ENT_ITEM FROM GP_EPI_ENT_BLOCO_ITEM";
                ...
                $query = "INSERT INTO GP_EPI_ENT_BLOCO_ITEM (ID_EPI_ENT, ID_EPI_ENT_ITEM, COD_CA, TIPO_EPI, QTD_EPI, N_H, DATA, BLOCO_EPI, DATA_CADASTRO, USUARIO_CADASTRO)
                                 VALUES ($id, $novoId, '$descricaoCodCa', '$tipoEpi', '$qtdEpi', '$estadoEpi', '$dataEpi', '$blocoEpi', SYSDATE, '$usuarioLogado')";
    ...
    public function excluir($id) {
        ...
        $query = "DELETE FROM GP_EPI_ENT_BLOCO WHERE ID_EPI_ENT = $id";
        ...
        if ($resultado == true || $resultado == 1) {
            ...
            $query = "DELETE FROM GP_EPI_ENT_BLOCO_ITEM WHERE ID_EPI_ENT = $id";
    ...
    public function getGrid($indice, $ordem, $inicio, $tamanho, $draw, $idFuncionarioFiltro) {
        ...
        $query = "SELECT * FROM GP_EPI_ENT_BLOCO WHERE 1 = 1 ";
    ...
    private function getCountGrid() {
        ...
        $query = "SELECT COUNT(ID_EPI_ENT) AS TOTAL FROM GP_EPI_ENT_BLOCO";
    ...
    public function selecionaGrid($id) {
        ...
        $query = "SELECT * FROM GP_EPI_ENT_BLOCO WHERE ID_EPI = $id";
    ...
    public function getItemLancamentoEditarEd($id) {
        ...
        $query = "SELECT COUNT(*) AS TOTAL FROM GP_EPI_ENT_BLOCO_ITEM WHERE ID_EPI_ENT =  '$id'";
        ...
        $query = "SELECT COUNT(*) AS TOTAL FROM GP_EPI_ENT_BLOCO_ITEM_TEMP WHERE ID_EPI_ENT =  '$id'";
        ...
        $query = "SELECT * FROM GP_EPI_ENT_BLOCO_ITEM_TEMP WHERE ID_EPI_ENT =  '$id' ORDER BY ID_EPI_ENT_ITEM";
        ...
        $html .="<tr  style='width: 90%; padding-right: 5px; font-size: 14px;' align='center' >
                    ...
                    <td  style='width: 15%; padding-right: 5px;font-size: 14px;'>Nº Bloco</td>
        ...
        for ($i = $i; $i < $totalGeral; $i++) {
            ...
            $html .="<tr  style='width: 90%; padding-right: 5px; font-size: 14px;' align='center' >
                    ...
                    <td  style='width: 15%; padding-right: 5px;font-size: 14px;'><div class='form'><input  type='text' class='form-control' id='$dataEpi'    value='$dataEpiValor'  readonly ></div></td>
                    <td  style='width: 15%; padding-right: 5px;font-size: 14px;'><div class='form'><input  type='text' class='form-control' id='$blocoEpi'    value='$blocoEpiValor' readonly ></div></td>
    ...
    public function getItemLancamento($id) {
        ...
        if (is_array($rs) && count($rs) == null || is_array($rs) && count($rs) == "null") {
            ...
            $query = "SELECT * FROM GP_EPI_ENT_BLOCO_ITEM WHERE ID_EPI_ENT = '$id' ORDER BY ID_EPI_ENT_ITEM";
...
//            
    ...
    public function editarItemLancamentoTemporario($idLancamentoItem, $id) {
        ...
        $query = "SELECT * FROM GP_EPI_ENT_BLOCO_ITEM WHERE ID_EPI_ENT = '$id' AND ID_EPI_ENT_ITEM = '$idLancamentoItem' ";
        //print_r($query); exit();
        $cs = $this->conBanco->query($query);
        $rs = $cs->result();
...
//            
    ...
    public function editarItemLancamento($idLancamentoItem, $id) {
        ...
        if (is_array($rs) && count($rs) > 0) {
            ...
            $query = "SELECT * FROM GP_EPI_ENT_BLOCO_ITEM_TEMP WHERE ID_EPI_ENT = '$id' AND ID_EPI_ENT_ITEM = '$idLancamentoItem'";
            //print_r($query); exit();
            $cs = $this->conBanco->query($query);
            $rs = $cs->result();
    ...
    public function excluirLancamentoModalEd($codCaEd, $id) {
        ...
        $query = "DELETE FROM GP_EPI_ENT_BLOCO_ITEM_TEMP WHERE ID_EPI_ENT = '$id' AND COD_CA = '$descricaoCodCa'";
    ...
    public function excluirLancamentoModalEdEd($codCaEdEd, $id) {
        ...
        if ($resultado == true || $resultado == 1) {
            ...
            $query = "DELETE FROM GP_EPI_ENT_BLOCO_ITEM WHERE ID_EPI_ENT = '$id' AND COD_CA = '$descricaoCodCa'";
    ...
    public function salvarItensLancamentos($id, $codCa, $tipoEpi, $qtdEpi, $estadoEpi, $dataEpi, $blocoEpi) {
        // print_r("salvarDescricao");exit();
        $this->initConBanco();



        $query = "SELECT * FROM GP_EPI_ENT_BLOCO_ITEM  WHERE ID_EPI_ENT = '$id' AND COD_CA = '$codCa'";
        ...
        if (is_array($rs) && count($rs) > 0) {
            ...
            $query = "UPDATE GP_EPI_ENT_BLOCO_ITEM SET COD_CA = '$codCa', TIPO_EPI = '$tipoEpi', QTD_EPI = '$qtdEpi', N_H = '$estadoEpi', DATA = '$dataEpi', BLOCO_EPI = '$blocoEpi', DATA_ALTERACAO = SYSDATE, USUARIO_ALTERACAO = '$usuarioLogado' WHERE ID_EPI_ENT '%$id%' AND  COD_CA = '$codCa'";
            ...
            $query = "INSERT INTO GP_EPI_ENT_BLOCO_ITEM (ID_EPI_ENT, ID_EPI_ENT_ITEM, COD_CA, TIPO_EPI, QTD_EPI, N_H, DATA, BLOCO_EPI, DATA_CADASTRO, USUARIO_CADASTRO)
                                 VALUES ($id, $novoId, '$codCa', '$tipoEpi', '$qtdEpi', '$estadoEpi', '$dataEpi', '$blocoEpi', SYSDATE, '$usuarioLogado')";
    ...
    public function excluirDadosTemp() {
        ...
        $query = "DELETE GP_EPI_ENT_BLOCO_ITEM_TEMP WHERE ID_EPI_ENT >= 1";
        //print_r($query);exit();
        $resultado = $this->conBanco->query($query);

        if ($resultado == true || $resultado == 1) {

            $query = "DELETE FROM GP_EPI_ENT_BLOCO_ITEM_TEMP WHERE ID_EPI_ENT >= 1";
    ...
    public function getPdf($id, $idFuncionario) {
        ...
        $query = " SELECT T1.ID_EPI_ENT_ITEM, T1.COD_CA, T1.TIPO_EPI, T1.QTD_EPI, T1.N_H, T1.DATA, T1.BLOCO_EPI FROM GP_EPI_ENT_BLOCO_ITEM T1 INNER JOIN GP_EPI_ENT_BLOCO T2
        ...
        $nomeDoArquivo = "relatorio_entregaEpiDireto.pdf";
