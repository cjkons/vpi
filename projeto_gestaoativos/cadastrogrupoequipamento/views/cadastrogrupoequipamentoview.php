...
<html lang="pt-br">
    <head>
        ...
        <!-- CADASTRO EVENTO -->
        <script src="resources/cadastrogrupoequipamento/js/cadastrogrupoequipamento.js"></script>
        <!-- CADASTRO EVENTO -->
    </head>
        ...
        <table style="width: 80%; border-collapse: collapse" cellpadding="0" cellspacing="5px" align="center" >
                <tr>
                    ...
                    <td  style="padding-right: 10px;font-size: 14px;">
                        <div class="form">
                            Código Grupo
                            <input type="text" class="form-control" id="codGrupo"   placeholder="Código Grupo" readonly>
                        </div>
                    </td>
                    <td  style="padding-right: 10px;font-size: 14px;">
                        <div class="form">
                            Descrição
                            <input type="text" class="form-control" id="descricaoGrupo"   placeholder="Descrição" readonly>
                        </div>
                    </td>
                </tr>
