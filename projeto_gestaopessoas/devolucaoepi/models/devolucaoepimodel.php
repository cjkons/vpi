<?php
require_once("resources/devolucaoepi/dompdf/dompdf_config.inc.php");

class devolucaoepimodel extends CI_Model { 
    ...
    public function novo() {
        ...
        $query = "SELECT max(ID_EPI_DEV) AS ID FROM  GP_EPI_DEV";
    ...
    public function verificarLancamentoEpi($id, $idFuncionario) {
        ...
        $query = "SELECT * FROM GP_EPI_DEV WHERE FUNCIONARIO = '$idFuncionario'";
            ...
            if (is_array($rs) && count($rs) > 0) {
                ...
                $query = "SELECT * FROM GP_EPI_DEV WHERE ID_EPI_DEV = '$id' AND  FUNCIONARIO = '$idFuncionario'";
    ...
    public function salvar($id, $idFuncionario, $matricula, $setor, $funcao, $dataAdmissao) {
        ...
        if (is_array($rs) && count($rs) > 0) {
            ...
            $query = "UPDATE GP_EPI_DEV SET FUNCIONARIO  = '$idFuncionario' , MATRICULA = '$matricula', SETOR = '$setor', FUNCAO = '$funcao', DATA_ADMISSAO = '$dataAdmissao', DATA_ALTERACAO = SYSDATE, USUARIO_ALTERACAO = '$usuarioLogado' WHERE ID_EPI_DEV = $id";
            //print_r($query);exit();
            ...
            $query = "INSERT INTO GP_EPI_DEV (ID_EPI_DEV, FUNCIONARIO, MATRICULA, SETOR, FUNCAO, DATA_ADMISSAO, DATA_CADASTRO, USUARIO_CADASTRO)
...
///// SE O ID NAO ESTIVER SALVO, VAI SALVAR OS FILHOS NA TABELA ITEM TEMP     
        if (is_array($rs) && count($rs) == null) {
            ...
            $query = "SELECT * FROM GP_EPI_DEV_ITEM_TEMP  WHERE ID_EPI_DEV = '$id' AND COD_CA = '$descricaoCodCa'";
            ...
            $query = "SELECT * FROM GP_EPI_DEV_ITEM WHERE ID_EPI_DEV = '$id' AND COD_CA = '$descricaoCodCa'";
...
///// SE O ID NAO ESTIVER SALVO, VAI SALVAR OS FILHOS NA TABELA ITEM TEMP     
        if (is_array($rs) && count($rs) == null) {
            ...
            if (is_array($rs) && count($rs) > 0) {
                ...
                $query = "UPDATE GP_EPI_DEV_ITEM_TEMP SET COD_CA = '$descricaoCodCa', TIPO_EPI = '$tipoEpi', QTD_EPI = '$qtdEpi', N_H = '$estadoEpi', DATA = '$dataEpi', BLOCO_EPI = '$blocoEpi', TIPO_LANCAMENTO = '$tipoLancamento', DATA_ALTERACAO = SYSDATE, USUARIO_ALTERACAO = '$usuarioLogado' WHERE ID_EPI_DEV LIKE '%$id%' AND COD_CA = '$descricaoCodCa'";
                ...
                $query = "SELECT MAX(ID_EPI_DEV_ITEM) AS ID_EPI_DEV_ITEM FROM GP_EPI_DEV_ITEM_TEMP";
                ...
                if (count($rs) == 0) {
                    ...
                    $novoId = $rs[0]->ID_EPI_DEV_ITEM + 1;
                }


                $query = "INSERT INTO GP_EPI_DEV_ITEM_TEMP (ID_EPI_DEV, ID_EPI_DEV_ITEM, COD_CA, TIPO_EPI, QTD_EPI, N_H, DATA, BLOCO_EPI, TIPO_LANCAMENTO, DATA_CADASTRO, USUARIO_CADASTRO)
...
/// SENAO VAI SALVAR OS FILHOS NA TABELA ITEM            
            ...
            if (is_array($rs) && count($rs) > 0) {
                ...
                $query = "UPDATE GP_EPI_DEV_ITEM SET COD_CA = '$descricaoCodCa', TIPO_EPI = '$tipoEpi', QTD_EPI = '$qtdEpi', N_H = '$estadoEpi', DATA = '$dataEpi', BLOCO_EPI = '$blocoEpi', TIPO_LANCAMENTO = '$tipoLancamento', DATA_ALTERACAO = SYSDATE, USUARIO_ALTERACAO = '$usuarioLogado' WHERE ID_EPI_DEV LIKE '%$id%' AND COD_CA = '$descricaoCodCa'";
                ...
                $query = "SELECT MAX(ID_EPI_DEV_ITEM) AS ID_EPI_DEV_ITEM FROM GP_EPI_DEV_ITEM";
                ...
                $query = "INSERT INTO GP_EPI_DEV_ITEM (ID_EPI_DEV, ID_EPI_DEV_ITEM, COD_CA, TIPO_EPI, QTD_EPI, N_H, DATA, BLOCO_EPI, TIPO_LANCAMENTO, DATA_CADASTRO, USUARIO_CADASTRO)
                                 VALUES ($id, $novoId, '$descricaoCodCa', '$tipoEpi', '$qtdEpi', '$estadoEpi', '$dataEpi', '$blocoEpi', '$tipoLancamento', SYSDATE, '$usuarioLogado')";
    ...
    public function excluir($id) {
        ...
        $query = "DELETE FROM GP_EPI_DEV WHERE ID_EPI_DEV = $id";
        ...
        if ($resultado == true || $resultado == 1) {
            ...
            $query = "DELETE FROM GP_EPI_DEV_ITEM WHERE ID_EPI_DEV = $id";
    ...
    public function getGrid($indice, $ordem, $inicio, $tamanho, $draw, $idFuncionarioFiltro) {
        ...
        $query = "SELECT * FROM GP_EPI_DEV WHERE 1 = 1 ";
        ...
        $query .= "ORDER BY ID_EPI_DEV DESC";
    ...
    private function getCountGrid() {
        ...
        $query = "SELECT COUNT(ID_EPI_DEV) AS TOTAL FROM GP_EPI_DEV";
    ...
    public function selecionaGrid($id) {
        ...
        $query = "SELECT * FROM GP_EPI_DEV WHERE ID_EPI = $id";
...
//            
    ...
    public function getItemLancamentoEditar($id) {
        ...
        $query = "SELECT * FROM GP_EPI_DEV_ITEM_BLOCO_TEMP WHERE ID_EPI_DEV =  '$id' ORDER BY ID_EPI_DEV_ITEM";
...
//            
    ...
    public function editarItemLancamento($idLancamentoItem, $id, $matricula) {
        ...
        if (is_array($rs) && count($rs) > 0) {
            ...
            $query = "SELECT * FROM GP_EPI_DEV_ITEM_TEMP WHERE ID_EPI_DEV = '$id' AND ID_EPI_DEV_ITEM = '$idLancamentoItem'";
            //print_r($query); exit();
            $cs = $this->conBanco->query($query);
            $rs = $cs->result();
    ...
    public function excluirLancamentoModalEd($codCaEd, $id) {
        ...
        $query = "DELETE FROM GP_EPI_DEV_ITEM_TEMP WHERE ID_EPI_DEV = '$id' AND COD_CA = '$descricaoCodCa'";
    ...
    public function excluirLancamentoModalEdEd($codCaEdEd, $id) {
        ...
        if ($resultado == true || $resultado == 1) {
            ...
            $query = "DELETE FROM GP_EPI_DEV_ITEM WHERE ID_EPI_DEV = '$id' AND COD_CA = '$descricaoCodCa'";
    ...
    public function salvarItensLancamentos($id, $codCa, $tipoEpi, $qtdEpi, $estadoEpi, $dataEpi, $tipoLancamento, $blocoEpi) {
        ...
        if ($estadoEpi == "DESCARTE NATURAL") {

            $estadoEpi = "D";
        } elseif ($estadoEpi == "DESCARTE MAL USO") {

            $estadoEpi = "M";
        } elseif ($estadoEpi == "PERDA") {
        ...
        $query = "SELECT * FROM GP_EPI_DEV_ITEM  WHERE ID_EPI_DEV = '$id' AND COD_CA = '$codCa'";
        ...
        if (is_array($rs) && count($rs) > 0) {
            ...
            $query = "UPDATE GP_EPI_DEV_ITEM SET COD_CA = '$codCa', TIPO_EPI = '$tipoEpi', QTD_EPI = '$qtdEpi', N_H = '$estadoEpi', DATA = '$dataEpi', BLOCO_EPI = '$blocoEpi', TIPO_LANCAMENTO = '$tipoLancamento', DATA_ALTERACAO = SYSDATE, USUARIO_ALTERACAO = '$usuarioLogado' WHERE ID_EPI_DEV '%$id%' AND  COD_CA = '$codCa'";
    ...
    public function excluirDadosTemp() {
        ...
        $query = "DELETE GP_EPI_DEV_ITEM_TEMP WHERE ID_EPI_DEV >= 1";
        //print_r($query);exit();
        $resultado = $this->conBanco->query($query);

        if ($resultado == true || $resultado == 1) {

            $query = "DELETE FROM GP_EPI_DEV_ITEM_TEMP WHERE ID_EPI_DEV >= 1";
    ...
    public function getPdf($id, $idFuncionario) {
        ...
        $html .="<tr>";
        $html .="<td colspan = '7' style= 'border: 1 solid #000000; padding-top: 10px; padding-botton: 5px; width: 50%; font-size: 30px; color: #000000;' align='center'><br>DECLARAÇÃO DE DEVOLUÇÃO DE EPI<br><br></td>";
        $html .=" </tr>";                               
        ...
        $html .="</tr>";
        $html .="<tr>";
        $html .="<td colspan = '7' style= 'width: 100%; border-bottom: 1 solid #000000;font-size: 30px; color: #000000;'  align='left'>&nbsp;&nbsp;&nbsp;Entendo que no caso de perda, dano, extravio, ou avaria dos equipamentos referidos, aqui neste,<br>"
                . "                                                                                                                           autorizo desde já a dedução, do valor correspondente ao EPI do meu Salário. E que o descumprimento dos termos aqui"
                . "                                                                                                                           estabelecidos, importará em ato faltoso, com aplicação de penalidades, que a critério do empregador, independente de"
                . "                                                                                                                           outras medidas de ordem jurídica aplicáveis com base especialmente no Art. 158 da CLT e NR-01 da portaria do"
                . "                                                                                                                           Ministério do Trabalho e Emprego nº 3.214/78.<br><br></td>";
        $html .="</tr>";
        
        $html .="<tr>";
        $html .="<td colspan = '7' style= ' padding-top: 10px; padding-botton: 5px; width: 50%; font-size: 30px; color: #000000;' align='center'><br>DESCRIÇÃO DOS EPI'S RECEBIDOS DO FUNCIONÁRIO<br><br></td>";
        $html .="</tr>";
        $html .= "<tr class = 'linhaOc' style = 'width:100%;'>";
                $html .= "<td  style = 'text-transform: uppercase; width: 5%; font-size: 22px;' align = 'left'><b>Nº</b></td>";
                $html .= "<td  colspan = '2' style = 'text-transform: uppercase; width: 15%; font-size: 22px;' align = 'left'><b>CÓDIGO C.A.</b></td>";
        ...
        $query = " SELECT T1.ID_EPI_DEV_ITEM, T1.COD_CA, T1.TIPO_EPI, T1.QTD_EPI, T1.N_H, T1.DATA FROM GP_EPI_DEV_ITEM T1 INNER JOIN GP_EPI_DEV T2
                        ON T1.ID_EPI_DEV = T2.ID_EPI_DEV WHERE T2.FUNCIONARIO = '$idFuncionario' AND T2.ID_EPI_DEV = $id ";
        ...
        if (is_array($rs) && count($rs) > 0) {
            ...
            foreach ($rs as $item) {
                ...
                $estadoEpiValor = "DES. NATURAL";
                
                }
                elseif($estadoEpi == "M"){

                    $estadoEpiValor = "DES. MAU USO";
                ...
                $html .= "<tr class = 'linhaOc' style = 'width:100%;'>";
                $html .= "<td  style = 'text-transform: uppercase; width: 5%; font-size: 22px;' align = 'left'>$item->ID_EPI_DEV_ITEM</td>";
                $html .= "<td  colspan = '2' style = 'text-transform: uppercase; width: 15%; font-size: 22px;' align = 'left'>$item->COD_CA</td>";
                ...
                $html .= "<td  style = 'width: 3%; font-size: 22px;' align = 'left'>&nbsp;&nbsp;$estadoEpiValor</td>";
        ...
        $nomeDoArquivo = "relatorio_devolucaoEpiDireto.pdf";
...
//	}
        ...
        $nomeDoArquivo = "relatorio_devolucaoEpi.pdf";
