...
<html lang="pt-br">
    <head>
        ...
        <!--GERAL-->
        <link href="resources/entregaepi/css/teste.css" rel="stylesheet">
        ...
        <!-- CADASTRO EVENTO -->
        <script src="resources/entregaepi/js/entregaepi.js"></script>
        <!-- CADASTRO EVENTO -->
    </head>
                        ...
                        <table style="width: 90%; border-collapse: collapse" cellpadding="0" cellspacing="5px" align="center" >
                            <tr>
                                ...
                                <td  style="width: 10%; padding-right: 5px;font-size: 14px;">
                                    <div class="form">
                                        Quantidade
                                        <input type="text" class="form-control" id="qtdEpi"  placeholder="QTD" onchange ="verificarQuantidadePermitida()" readonly>
                                    </div>
                                </td>
