...
function carregarEmpresa(){
    ...
    $.ajax({
        url: 'index.php?m=relatoriocontroleexamesaso&c=relatoriocontroleexamesasocontroller&f=carregarEmpresa',
        data: {
...
function carregarFilial(){
    ...
    $.ajax({
        url: 'index.php?m=relatoriocontroleexamesaso&c=relatoriocontroleexamesasocontroller&f=carregarFilial',
        data: {
            idEmpresa: idEmpresa
...
function carregarDataAtual(){
     ...
     $.ajax({
        url: 'index.php?m=relatoriocontroleexamesaso&c=relatoriocontroleexamesasocontroller&f=carregarDataAtual',
        data: {
...
function filtro(){
   ...
   var controleDePreenchimento = 'S';
    ...
    if(controleDePreenchimento ==  'S'){
        ...
        $.ajax({
            url: 'index.php?m=relatoriocontroleexamesaso&c=relatoriocontroleexamesasocontroller&f=filtro',
            data: {
                mes: mes,
                idEmpresa: idEmpresa,
                idFilial: idFilial
...
function getPdf() {
   ...
   var controleDePreenchimento = 'S';
    ...
    if(controleDePreenchimento ==  'S'){
        ...
        $.ajax({
            url: 'index.php?m=relatoriocontroleexamesaso&c=relatoriocontroleexamesasocontroller&f=getPdf',
            data: {
                mes: mes,
                idEmpresa: idEmpresa,
                idFilial: idFilial,
...
function getExcel() {
   ...
   var controleDePreenchimento = 'S';
    ...
    $.ajax({
        url: 'index.php?m=relatoriocontroleexamesaso&c=relatoriocontroleexamesasocontroller&f=getExcel',
        data: {
...
function bloqueiaTela(texto) {
    ...
    $.blockUI({
        ...
        message: '<table class="carregando"><tr><td><img width="50px" src="resources/relatoriocontroleexamesaso/img/001.gif" /></td><td style="font-size: 18px;">' + texto + '</td></tr></table>'
    });
}
