...
<html lang="pt-br">
    <head>
        ...
        <!-- CADASTRO EVENTO -->
        <script src="resources/cadastrofamilia/js/cadastrofamilia.js"></script>
        <!-- CADASTRO EVENTO -->
    </head>
        ...
        <table style="width: 80%; border-collapse: collapse" cellpadding="0" cellspacing="5px" align="center" >
             <tr>
                    <td  style="padding-right: 10px;font-size: 14px;">
                           <div class="form">
                                Código Família
                                <input type="number" class="form-control" id="idFamilia"   placeholder="Código Família" readonly>
                           </div>
                    </td>
                    <td  style="padding-right: 10px;font-size: 14px;">
                       <div class="form">
                                Denominação
                                <input type="text" class="form-control" id="denominacaoFamilia"   placeholder="Denominação" readonly>
                        </div>
                   </td>
                    <td  style="padding-right: 10px;font-size: 14px;">
                        <div class="form">
                    ...
                    <td  style="padding-right: 10px;font-size: 14px;">
                        <div class="form">
                                Unidade medida
                                <select  id="unidadeMedida" class="form-control" placeholder="Unidade Medida" readonly></select>
                        </div>
                    </td>
                </tr>            
