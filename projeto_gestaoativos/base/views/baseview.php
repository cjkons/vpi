            ...
            <div class="container-fluid">
                ...
                <div id="navbar" class="navbar-collapse collapse" style='padding-right: 0px;'>
                    ...
                    <ul class="nav navbar-nav navbar-right">
                        ...
                        <li class="dropdown">
                            <a onclick="adicionarAba('Help Desk', 'HELPDESK_01_02', 'helpdesk-01-02', 'index.php?m=chamadotecnico&c=visualizarchamadocontroller')" href="#"><i class="glyphicon glyphicon-thumbs-up"></i>  Help Desk</span>
                            </a>
