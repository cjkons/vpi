...
<html lang="pt-br">
    <head>
        ...
        <!-- CADASTRO EVENTO -->
        <script src="resources/cadastroepitipo/js/cadastroepitipo.js"></script>
        <!-- CADASTRO EVENTO -->
    </head>
             ...
             <tr>
                <td  style="width: 10%; padding-right: 10px;font-size: 14px;">
                    <div class="form-group">
                        ID
                        <input type="number" class="form-control" id="idEpiTipo"   placeholder="ID" readonly>
                    </div>
                </td>
                <td  style="padding-right: 10px;font-size: 14px;">
                    <div class="form-group">
                        Tipo EPI
                        <input type="text" class="form-control" id="tipoEpi"   placeholder="Tipo EPI" readonly>
                    </div>
                </td>
                 <td  style="padding-right: 10px;font-size: 14px;">
                    <div class="form-group">
