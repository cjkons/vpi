...
<html lang="pt-br">
    <head>
        ...
        <!--GERAL-->
        <link href="resources/entregaepidireto/css/teste.css" rel="stylesheet">
        ...
        <!-- CADASTRO EVENTO -->
        <script src="resources/entregaepidireto/js/entregaepidireto.js"></script>
        <!-- CADASTRO EVENTO -->
    </head>
        ...
        <div class="modal-dialog-esp">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <h4 class="modal-title" id="myModalLabel">Entrega EPI Direto</h4>
                </div>
