                    ...
                    <ul class="sidebar-nav" >
                        ...
                        <li style="border-bottom: solid #e8e8e8 1px;">
                            <a onclick="" href="#" data-toggle="collapse" data-target="#menu_esquerdo_vendas" class="collapsed">
                                <span class='icone-menu-esquerdo glyphicon glyphicon-globe' style=''></span>Comercial
                                <div class="collapse" id="menu_esquerdo_vendas" style="height: 0px;">
                                    <ul>
                                        <li>
                                            <a onclick="adicionarAba('Cadastro Orçamento', 'VENDAS_03_03', 'vendas-03-03', 'index.php?m=cadastroorcamento&c=cadastroorcamentocontroller', 'resources/geral/images/cadastroOrcamento.jpg')" href="#"><span class='icone-menu-esquerdo glyphicon glyphicon-file' style=''></span>Cadastro Orçamento</a>
                                        </li> 
                                    </ul>
                                             ...
                                             <a onclick="" href="#" data-toggle="collapse" data-target="#sub_menu_esquerdo_financeiro_relatorio" class="collapsed">
                                                 ...
                                                 <div class="collapse" id="sub_menu_esquerdo_financeiro_relatorio" style="height: 0px;">
                                                    <ul>
														 ...
														 <li>
                                                                <a onclick="adicionarAba('Relatório Fluxo de Caixa Diário', 'FINRELATORIO_01_03', 'finrelatorio-01-03', 'index.php?m=relatoriofluxocaixadiario&c=relatoriofluxocaixadiariocontroller', 'resources/geral/images/relatorio_fluxo_caixa_diario.png')" href="#"><span class='icone-menu-esquerdo glyphicon glyphicon-file' style=''></span>Fluxo de Caixa Diário</a>
                                                            </li>
                                                            <li style="border-bottom: solid #e8e8e8 1px;">
                                                                <a onclick="" href="#" data-toggle="collapse" data-target="#sub_menu_esquerdo_financeiro_conciliacao" class="collapsed">
                                                                    <span class='icone-menu-esquerdo glyphicon glyphicon-import' style=''></span>Conciliação Bancária  
                                                                    <div class="collapse" id="sub_menu_esquerdo_financeiro_conciliacao" style="height: 0px;">
                                                                        <ul>
                                                                            <li>
                                                                                <a onclick="adicionarAba('Relatório Controle Interno', 'FINCONCILIACAO_01_01', 'finconciliacao-01-02', 'index.php?m=relatoriocontroleinterno&c=relatoriocontroleinternocontroller', 'resources/geral/images/relatorio_controle_interno.png')" href="#"><span class='icone-menu-esquerdo glyphicon glyphicon-file' style=''></span>Controle Interno</a>
                                                                            </li>
                        ...
                        <li style="border-bottom: solid #e8e8e8 1px;">
                            <a onclick="" href="#" data-toggle="collapse" data-target="#menu_esquerdo_equipamentos" class="collapsed">
                                ...
                                <div class="collapse" id="menu_esquerdo_equipamentos" style="height: 0px;">
                                    ...
                                    <ul>
                                     <li style="border-bottom: solid #e8e8e8 1px;">
                                        <a onclick="" href="#" data-toggle="collapse" data-target="#sub_menu_esquerdo_equipamento_boletim" class="collapsed">
                                            <span class='icone-menu-esquerdo glyphicon glyphicon-import' style=''></span>Boletins
                                            <div class="collapse" id="sub_menu_esquerdo_equipamento_boletim" style="height: 0px;">
                                                <ul>
                                                    <ul>
                                                        <li>
                                        ...
                                        <li style="border-bottom: solid #e8e8e8 1px">
                                                 ...
                                                 <div class="collapse" id="sub_menu_esquerdo_equipamento" style="height: 0px;">
                                                    <ul>
                                                         <li>
                                                          ...
                                                          <li>
                                                             <a onclick="adicionarAba('Parâmetros Boletim', 'EQUIPAMENTOS_03_07', 'equipamentos-03-07', 'index.php?m=parametrosboletimequipamento&c=parametrosboletimequipamentocontroller', 'resources/geral/images/parametrosboletim.jpg')" href="#"><span class='icone-menu-esquerdo glyphicon glyphicon-file' style=''></span>Parâmetros Boletim</a>
                                                         </li>
                                          ...
                                          <li style="border-bottom: solid #e8e8e8 1px;">
                                             <a onclick="" href="#" data-toggle="collapse" data-target="#sub_menu_esquerdo_frota_relatorio" class="collapsed">
                                                 <span class='icone-menu-esquerdo glyphicon glyphicon-import' style=''></span>Relatórios  
                                                 <div class="collapse" id="sub_menu_esquerdo_frota_relatorio" style="height: 0px;">
                                                    <ul>
                                                        <li>
                                                             <a onclick="adicionarAba('Relatório Betoneira', 'EQUIPAMENTOS_03_10', 'equipamentos-03-10', 'index.php?m=relatoriobetoneira&c=relatoriobetoneiracontroller', 'resources/geral/images/relatorio_betoneira.png')" href="#"><span class='icone-menu-esquerdo glyphicon glyphicon-file' style=''></span>Relatório Betoneira</a>
                                                        </li> 
                                                         <li>
                                                             <a onclick="adicionarAba('Relatório Bomba', 'EQUIPAMENTOS_03_08', 'equipamentos-03-08', 'index.php?m=relatoriobomba&c=relatoriobombacontroller', 'resources/geral/images/relatorio_bomba.png')" href="#"><span class='icone-menu-esquerdo glyphicon glyphicon-file' style=''></span>Equipamento Bomba</a>
                                                         </li>                                                        
                                                         <li>
                                                             <a onclick="adicionarAba('Relatório Frete', 'EQUIPAMENTOS_03_09', 'equipamentos-03-09', 'index.php?m=relatoriofrete&c=relatoriofretecontroller', 'resources/geral/images/relatorio_frete.png')" href="#"><span class='icone-menu-esquerdo glyphicon glyphicon-file' style=''></span>Relatório Frete</a>
                                                         </li> 
                                             ...
                                             <a onclick="" href="#" data-toggle="collapse" data-target="#sub_menu_esquerdo_suprimentos" class="collapsed">
                                                 ...
                                                 <div class="collapse" id="sub_menu_esquerdo_suprimentos" style="height: 0px;">
                                                    <ul>
                                                         ...
                                                         <li>
                                                             <a onclick="adicionarAba('Custo Material Fornecedor', 'SUPRIMENTOS_02_05', 'suprimentos-02-05', 'index.php?m=customaterialfornecedor&c=customaterialfornecedorcontroller', 'resources/geral/images/customaterialfornecedor.jpg')" href="#"><span class='icone-menu-esquerdo glyphicon glyphicon-file' style=''></span>Custo Material Fornecedor</a>
                                                         </li>
                                                    </ul>
                                                 </div>
                                             </a>
