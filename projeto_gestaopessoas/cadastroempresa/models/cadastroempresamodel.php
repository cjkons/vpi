...
class cadastroempresamodel extends CI_Model {
    ...
    public function novo(){
        ...
        $query = "SELECT max(ID_EMPRESA) AS ID_EMPRESA FROM  GP_SYS_EMPRESA";
    ...
    public function salvar($idEmpresa, $grupoEmpresa, $razaoSocial, $codigoCNPJ, $nomeFantasia, $inscricaoEstadual, $inscricaoMunicipal, $ativoEmpresa, $endereco, $numero, $cep, $cidade, $bairro, $estado, $pais, $telefone1, $telefone2, $celular, $email){
        ...
        if (is_array($rs) && count($rs) > 0){
            ...
            $query = "SELECT MAX(ID) AS ID FROM  GP_SYS_EMPRESA";
            ...
            $query = "INSERT INTO GP_SYS_EMPRESA (ID, ID_EMPRESA, ID_GRUPO_EMPRESA, RAZAO_SOCIAL, COD_EMPRESA, NOME_FANTASIA, INSCRICAO_ESTADUAL, INSCRICAO_MUNICIPAL, ATIVO, ENDERECO, NUMERO, CEP, CIDADE, BAIRRO, ESTADO, PAIS, TELEFONE_1, TELEFONE_2, CELULAR, EMAIL, USUARIO_CADASTRADOR, DATA_CADASTRO)
    ...
    public function excluir($idEmpresa){
        ...
        $query = "DELETE FROM GP_SYS_EMPRESA WHERE ID_EMPRESA = $idEmpresa";
    ...
    public function buscaPrimeiroRegistro(){
        ...
        $query = "SELECT * FROM GP_SYS_EMPRESA ORDER BY ID_EMPRESA";
    ...
    public function buscaRegistroAnterior($idEmpresa){
        ...
        for($i =0; $i < 10; $i++){
            ...
            $query = "SELECT * FROM GP_SYS_EMPRESA WHERE ID_EMPRESA =  $idProcura";
    ...
    public function pesquisaSimples($idInicial, $nomeInicial){
        ...
        if($idInicial == "" || $idInicial == null ){
            ...
            $query = "SELECT * FROM GP_SYS_EMPRESA WHERE NOME_FANTASIA LIKE '%$nomeInicial%'";
            ...
            $query = "SELECT * FROM GP_SYS_EMPRESA WHERE ID_EMPRESA = '$idInicial'";
    ...
    private function getCountGrid(){
        ...
        $query = "SELECT COUNT(ID) AS TOTAL FROM GP_SYS_EMPRESA";
    ...
    public function carregarGrupoEmpresa(){
        ...
        $query = "SELECT ID_GRUPO_EMPRESA, DENOMINACAO FROM GP_SYS_GRUPO_EMPRESA ORDER BY DENOMINACAO ";
