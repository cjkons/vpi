...
class cadastrofilialmodel extends CI_Model {
    ...
    public function novo(){
        ...
        $query = "SELECT max(ID_EMPRESA_FILIAL) AS ID_EMPRESA_FILIAL FROM  GA_SYS_EMPRESA_FILIAL";
    ...
    public function salvar($idFilial, $empresa, $razaoSocial, $nomeFantasia, $codigoCNPJ, $codigoCEI, $ativoFilial, $projetoFlial, $inscricaoEstadual, $inscricaoMunicipal, $endereco, $numero, $cep, $cidade, $bairro, $estado, $pais, $telefone1, $telefone2, $celular, $email, $tipo){
        ...
        $query = "SELECT * FROM GA_SYS_EMPRESA_FILIAL  WHERE ID_EMPRESA_FILIAL = $idFilial";
        ...
        if (is_array($rs) && count($rs) > 0){
            ...
            $query = "UPDATE GA_SYS_EMPRESA_FILIAL SET ID_EMPRESA_FILIAL= '$idFilial',  ID_EMPRESA  = '$empresa' , RAZAO_SOCIAL = '$razaoSocial', NOME_FANTASIA = '$nomeFantasia', COD_EMPRESA = '$codigoCNPJ', CEI = '$codigoCEI', ATIVO = '$ativoFilial', PROJETO  = '$projetoFlial', INSCRICAO_ESTADUAL = '$inscricaoEstadual', INSCRICAO_MUNICIPAL = '$inscricaoMunicipal', ENDERECO = '$endereco', NUMERO = '$numero',  CEP = '$cep', CIDADE = '$cidade', BAIRRO = '$bairro', ESTADO = '$estado',  PAIS = '$pais', TELEFONE_1 = '$telefone1', TELEFONE_2 = '$telefone2', CELULAR = '$celular', EMAIL = '$email', USUARIO_ALTERADOR = '$usuarioLogado', DATA_ALTERACAO = SYSDATE WHERE ID_EMPRESA_FILIAL = $idFilial";
           ...
           // print_r($query);exit();
            ...
            $query = "SELECT MAX(ID)  AS ID FROM  GA_SYS_EMPRESA_FILIAL";
            ...
            $query = "INSERT INTO GA_SYS_EMPRESA_FILIAL (ID, ID_EMPRESA_FILIAL, ID_EMPRESA, RAZAO_SOCIAL, NOME_FANTASIA, COD_EMPRESA, CEI, ATIVO, INSCRICAO_ESTADUAL, INSCRICAO_MUNICIPAL, ENDERECO, NUMERO, CEP, CIDADE, BAIRRO, ESTADO, PAIS, TELEFONE_1, TELEFONE_2, CELULAR, EMAIL, USUARIO_CADASTRO, DATA_CADASTRO, TIPO_CODIGO, PROJETO)
    ...
    public function excluir($idFilial){
        ...
        $query = "DELETE FROM GA_SYS_EMPRESA_FILIAL WHERE ID_EMPRESA_FILIAL = $idFilial";
    ...
    public function buscaPrimeiroRegistro(){
        ...
        $query = "SELECT * FROM GA_SYS_EMPRESA_FILIAL ORDER BY ID_EMPRESA_FILIAL";
    ...
    public function buscaRegistroAnterior($idFilial){
        ...
        for($i =0; $i < 10; $i++){
            ...
            $query = "SELECT * FROM GA_SYS_EMPRESA_FILIAL WHERE ID_EMPRESA_FILIAL =  $idProcura" ;
    ...
    public function pesquisaSimples($idInicial, $nomeInicial){
      ...
      $this->initConEngSys();
        ...
        if($idInicial == "" || $idInicial == null ){
            ...
            $query = "SELECT * FROM GA_SYS_EMPRESA_FILIAL WHERE NOME_FANTASIA LIKE '%$nomeInicial%'";
            ...
            $query = "SELECT * FROM GA_SYS_EMPRESA_FILIAL WHERE ID_EMPRESA_FILIAL = '$idInicial'";
    ...
    private function getCountGrid(){
        ...
        $query = "SELECT COUNT(ID) AS TOTAL FROM GA_SYS_EMPRESA_FILIAL";
