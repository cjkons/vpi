...
<html lang="pt-br">
    <head>
        <title>Cadastro Comprador</title>
        <meta charset="UTF-8"/>
        ...
        <!-- CADASTRO EVENTO -->
        <script src="resources/cadastrocomprador/js/cadastrocomprador.js"></script>
        <!-- CADASTRO EVENTO -->
    </head>
        ...
        <table style="width: 80%; border-collapse: collapse" cellpadding="0" cellspacing="5px" align="center" >
             <tr>
                    <td  style="padding-right: 10px;font-size: 14px;">
                           <div class="form">
                                ID Comprador
                                <input type="number" class="form-control" id="idComprador"   placeholder="ID Comprador" readonly>
                           </div>
                    </td>
                    <td  style="padding-right: 10px;font-size: 14px;">
                        <div class="form">
                    ...
                    <td  style="padding-right: 10px;font-size: 14px;">
                           <div class="form">
                                Filial
                                <select  id="idFilial" class="form-control"  readonly></select>
                           </div>
                    </td>
                     <td  style="padding-right: 10px;font-size: 14px;">
                       <div class="form">
                                Nome Comprador
                                <input type="text" class="form-control" id="nomeComprador" maxlength="60"  placeholder="Nome Comprador" readonly>
                        </div>
                   </td>
                   <td  style="padding-right: 10px;font-size: 14px;">
                        <div class="form">
                                Login
                                <input type="text" class="form-control" id="login"   placeholder="Login" readonly>
                        </div>
                    </td>
                    <td  style="padding-right: 10px;font-size: 14px;">
                        <div class="checkbox">
