...
$(document).ready( function() {
   ...
   $('#cep').blur(function(){
           ...
           $.ajax({
                url : 'index.php?m=cadastrofuncionarios&c=cadastrofuncionarioscontroller&f=consultarCep', /* URL que será chamada */ 
...
function novo(){
    ...
    $.ajax({
        url: 'index.php?m=cadastrofuncionarios&c=cadastrofuncionarioscontroller&f=novo',
        data: {
...
// SE FOR INSERIDO IMAGEM 
        if (imagem != "") {
            ...
            $.ajax({
                url: 'index.php?m=cadastrofuncionarios&c=cadastrofuncionarioscontroller&f=salvarAnexoImagem',
                type: 'POST',
                cache: false,
                data: fd1,
                processData: false,
...
function carregarEmpresa(){
    ...
    $.ajax({
        url: 'index.php?m=cadastrofuncionarios&c=cadastrofuncionarioscontroller&f=carregarEmpresa',
        data: {
...
function carregarFilial(){
    ...
    $.ajax({
        url: 'index.php?m=cadastrofuncionarios&c=cadastrofuncionarioscontroller&f=carregarFilial',
        data: {
            empresa: empresa
...
function carregarFuncao(){
    ...
    $.ajax({
        url: 'index.php?m=cadastrofuncionarios&c=cadastrofuncionarioscontroller&f=carregarFuncao',
        data: {
...
function carregarSetor(){
    ...
    $.ajax({
        url: 'index.php?m=cadastrofuncionarios&c=cadastrofuncionarioscontroller&f=carregarSetor',
        data: {
...
function carregarDataAtual() {
    ...
    $.ajax({
        url: 'index.php?m=cadastrofuncionarios&c=cadastrofuncionarioscontroller&f=carregarDataAtual',
        data: {
        },
        type: 'POST',
        dataType: 'json',
