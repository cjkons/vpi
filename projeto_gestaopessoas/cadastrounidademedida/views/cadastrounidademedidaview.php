...
<html lang="pt-br">
    <head>
        ...
        <!-- CADASTRO EVENTO -->
        <script src="resources/cadastrounidademedida/js/cadastrounidademedida.js"></script>
        <!-- CADASTRO EVENTO -->
    </head>
    ...
    <body style="zoom: 85%;">
        ...
        <table style="width: 80%; border-collapse: collapse" cellpadding="0" cellspacing="5px" align="center" >
            <tr>
                <td  style="padding-right: 10x;font-size: 14px;">
                    <font size="3">Código Unidade</font>
                    <input type="text" class="form-control" id="codigoUnidade" maxlength="18"  placeholder="Código Unidade" readonly>
                </td>
                <td  style="padding-right: 10px;font-size: 14px;">
                     <font size="3">Denominação</font>
                    <input type="text" class="form-control" id="denominacaoUnidade"  placeholder="Denominação" readonly>
                </td>
                <td  style="padding-right: 10px;font-size: 14px;">
                     <font size="3">Data Cadastro</font>
                    <input type="text" class="form-control" id="dataCadastro"   placeholder="Data Cadastro" readonly>
                </td>
                <td  style="padding-right: 10px;font-size: 14px;">
                    <input type="checkbox" id="ativoUnidade" name="ativoUnidade" disabled="true"/>
                    <font size="3">Ativo</font>
                </td>
            </tr>
