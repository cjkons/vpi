...
<html lang="pt-br">
    <head>
        ...
        <link href="resources/cockpitcontasapagar/css/teste.css" rel="stylesheet">
        ...
        <!-- CADASTRO EVENTO -->
        <link href="resources/cockpitcontasapagar/css/estilomodal.css" rel="stylesheet">
        <script src="resources/cockpitcontasapagar/js/cockpitcontasapagar.js"></script>
    ...
    <body style="zoom: 85%;" >
        ...
        <table style="width: 80%; border-collapse: collapse" cellpadding="0" cellspacing="5px" align="center" >
                <tr>
                    <td  style="padding-right: 5px;font-size: 14px;">
                        <div class="form">
                            Empresa
                            <select  id="idEmpresaFiltro" class="form-control"  onchange="carregarFilialFiltro()" ></select>
                        </div>
                    </td>
                    <td  style="padding-right: 5px;font-size: 14px;">
                        <div class="form">
                            Filial
                            <select  id="idFilialFiltro" class="form-control"  ></select>
                        </div>
                    </td>
                    <td  style="padding-right: 5px;font-size: 14px;">
                        <div class="form">
                          Data
                            <select  id="tipoData" class="form-control" onchange="carregarDataAtual()">
                                <option value="0" readonly>Selecione</option>
                                <option value="Data Proposta"  >Data Proposta</option>
                    ...
                    <td  style="padding-right: 5px;font-size: 14px;">
                        <div class="form">
                            Período Inicial
                            <input type='text' class="form-control" id="periodoIni"  maxlength="10" placeholder="Data Inicial">
                        </div>
                    </td>
                    <td  style="padding-right: 5px;font-size: 14px;">
                        <div class="form">
                    ...
                    <td  style="padding-right: 10px;font-size: 14px;">
                        <div class="form">
                            ...
                            <select  id="situacao" class="form-control">
                                <option value="0" readonly>Selecione</option>
                                <option value="Aberto" readonly>Aberto</option>
                                <option value="Pago" readonly>Pago</option>
                            </select>
                        </div>
                    </td>
        ...
        <HR WIDTH=100%>
        <br>
        <table id="total" style="width: 80%; border-collapse: collapse" cellpadding="0" cellspacing="5px" align="center" ></table>
